"""Debug script for Season 2 Ep 18 MIP solver issue."""
import json
import numpy as np
...
print(f"Expected values (b) after: {solver.b[:15]}")  # Show first 15
